      ...
      <div className="flex h-full min-h-0">
        <div className="min-w-0 flex-1 overflow-y-scroll [scrollbar-gutter:stable]">
          <div className="mx-auto w-full max-w-5xl px-4 py-6 xl:px-6">
            {error && <div role="alert" className="mb-3 rounded border border-destructive/30 bg-destructive/10 px-3 py-2 text-[12px] text-destructive">Unable to load Inbox. Refresh the page to try again. Your workspace data is unchanged.</div>}
            ...
            <Dialog open={clearAllOpen} onOpenChange={(open) => { if (!open && !clearAllPending) setClearAllOpen(false); }}>
              <DialogContent className="max-w-sm p-5">
                <DialogHeader className="text-left">
                  <DialogTitle className="text-[15px] font-semibold">Clear Inbox?</DialogTitle>
