  ...
  return (
    ...
    >
      <div className="flex h-full min-h-0 w-full">
        {error && <div role="alert" className="absolute left-6 right-6 top-3 z-40 rounded border border-destructive/30 bg-destructive/10 px-3 py-2 text-[12px] text-destructive">Unable to load calendar. Refresh the page to try again. Your workspace data is unchanged.</div>}
