        ...
        <div className="min-w-0 flex-1 overflow-x-hidden overflow-y-auto [scrollbar-gutter:stable]">
          <div className="mx-auto w-full max-w-6xl py-4 sm:px-4 sm:py-5 lg:px-6">
            <div className="app-workspace-canvas space-y-6 px-4 py-5 sm:px-6 lg:px-8 lg:py-6">
              {error && <div className="rounded-lg border border-destructive/30 bg-destructive/10 px-3 py-2 text-[10.5px] text-destructive">Unable to load Home. Refresh the page to try again. Your workspace data is unchanged.</div>}
              ...
              <div>
                <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                  ...
                  {loading ? <span className="font-mono text-[10px] text-muted-foreground">Loading home data...</span> : null}
                </div>
                ...
                <div className="min-w-0 space-y-7 lg:col-span-7">
                    ...
                    <SectionHeader
                      ...
                      action={
                        buckets.today.length > previewLimit ? (
                          <Link href={taskHref("today")} className="font-mono text-[10px] text-muted-foreground hover:text-foreground">Show all</Link>
                        ) : null
                      }
                    />
                  ...
                  <section>
                    <SectionHeader
                      ...
                      action={<Link href={`${basePath}/inbox`} className="font-mono text-[10px] text-muted-foreground hover:text-foreground">Open Inbox</Link>}
                    />
                    <div className="border-t border-border">
                      <TaskList
                        items={inboxPreview}
                ...
                <aside className="min-w-0 space-y-7 lg:col-span-5 lg:border-l lg:border-border lg:pl-8">
                  ...
                  <section>
                    <SectionHeader
                      ...
                      action={<Link href={`${basePath}/calendar`} className="font-mono text-[10px] text-muted-foreground hover:text-foreground">Calendar</Link>}
                    />
                    <div className="border-t border-border">
                      <TaskList
                  ...
                  <section>
                    <SectionHeader
                      ...
                      action={<Link href={`${basePath}/notes`} className="font-mono text-[10px] text-muted-foreground hover:text-foreground">Notes</Link>}
                    />
