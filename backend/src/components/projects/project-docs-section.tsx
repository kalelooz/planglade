  ...
  return (
    <section className="grid min-h-[520px] gap-4 lg:grid-cols-[280px_minmax(0,1fr)]">
      ...
      <div className="rounded-md border bg-card">
        ...
        {error && <div id="project-doc-error" role="alert" className="mx-4 mt-3 rounded border border-destructive/30 bg-destructive/10 px-3 py-2 text-[12px] text-destructive">{error}</div>}
        ...
        <div className="space-y-3 p-4">
          <label className="block">
            ...
            <input
              ...
              aria-describedby={error === "Add a title before saving." ? "project-doc-error" : undefined}
