    ...
    <>
      ...
      <motion.aside
        ...
        className={placement === "overlay"
          ? "fixed inset-y-0 right-0 z-[90] flex w-full max-w-[420px] flex-col border-l border-border/80 bg-background shadow-xl"
          : "flex w-full min-w-0 flex-col rounded-lg border border-border/80 bg-background shadow-xs lg:sticky lg:top-4 lg:max-h-[calc(100vh-9rem)] lg:w-[360px] lg:shrink-0"}
      >
      <div className="flex h-11 items-center justify-between border-b border-zinc-100 px-4">
        ...
        <button onClick={onClose} title="Close" aria-label="Close task drawer" className="lov-icon-btn"><X className="h-3.5 w-3.5" aria-hidden="true" /></button>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        ...
        <textarea
          ...
          rows={2}
          className="mb-2 w-full resize-y bg-transparent text-base leading-relaxed text-foreground/90 outline-none placeholder:text-muted-foreground/60 sm:text-[13px]"
        />
        ...
        <dl className="mt-4 grid grid-cols-[80px_1fr] gap-y-3 text-[12px]">
          ...
          <dd>
            <input
              ...
              className="rounded border bg-card px-2 py-1 text-base outline-none focus:border-ring sm:text-[12px]"
            />
          </dd>
          ...
          <dd>
            <input
              ...
              className="w-32 rounded border bg-card px-2 py-1 text-base outline-none focus:border-ring sm:text-[12px]"
            />
          </dd>
          ...
          <ul className="space-y-2 text-[13px]">
            ...
            <li className="flex items-center gap-2.5 px-1 py-0.5">
              ...
              <input
                ...
                className="h-7 flex-1 bg-transparent text-base outline-none placeholder:text-muted-foreground/60 sm:text-[13px]"
              />
            </li>
          </ul>
        </div>
          ...
          <div ref={commentsSectionRef} className="mt-5 border-t pt-4">
            ...
            <div className="mb-3">
              <textarea
                ...
                aria-describedby={commentError ? "legacy-task-comment-error" : undefined}
                value={commentDraft}
                ...
                rows={3}
                className="w-full resize-y rounded border bg-card px-2 py-1.5 text-base outline-none focus:border-ring sm:text-[12px]"
              />
              ...
              {commentError && <p id="legacy-task-comment-error" className="mt-1 text-[11px] text-red-600">{commentError}</p>}
  ...
  return (
    <span className="flex items-center gap-2">
      ...
      <select
        ...
        className="bg-transparent text-base outline-none hover:underline sm:text-[12px]"
      >
