    ...
    <div className="grid min-h-screen grid-cols-1 bg-background text-foreground lg:grid-cols-[1fr_440px]">
      ...
      <div className="flex flex-col items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <Link to="/" className="mb-10 flex items-center gap-2 text-sm font-semibold lg:hidden">
            <span className="flex h-6 w-6 items-center justify-center rounded bg-foreground text-[11px] font-bold text-background">FB</span>
            FlowBoard
          </Link>
          ...
          <button className="mt-8 flex h-10 w-full items-center justify-center gap-2.5 rounded-md border bg-card text-[13px] font-medium hover:bg-hover">
          ...
          <Link to="/" className="mt-3 flex h-9 w-full items-center justify-center gap-1.5 rounded-md bg-primary text-[13px] font-medium text-primary-foreground hover:opacity-90">
