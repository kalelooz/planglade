            ...
            <div className="space-y-5">
              {credentials && (
                <form className="space-y-4" onSubmit={signInWithCredentials}>
                  ...
                  <div className="text-right"><Link to="/auth/recover" className="inline-flex min-h-11 items-center text-xs font-medium text-muted-foreground hover:text-foreground">Use a recovery code</Link></div>
                </form>
              )}
